...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function displayResults(currentData, forecastData) {
        ...
        document.querySelector('#current-temp-low').innerHTML = `${Math.floor(currentData.main.temp_min)}&deg;F`;
        document.querySelector('#current-temp-high').innerHTML = `${Math.ceil(currentData.main.temp_max)}&deg;F`;
        ...
        document.querySelector('#tomorrow-temp-low').innerHTML = `${Math.floor(forecastData.list[5].main.temp_min)}&deg;F`;
        document.querySelector('#tomorrow-temp-high').innerHTML = `${Math.ceil(forecastData.list[5].main.temp_max)}&deg;F`;
        ...
        document.querySelector('#day-after-tomorrow-temp-low').innerHTML = `${Math.floor(forecastData.list[13].main.temp_min)}&deg;F`;
        document.querySelector('#day-after-tomorrow-temp-high').innerHTML = `${Math.ceil(forecastData.list[13].main.temp_max)}&deg;F`;
